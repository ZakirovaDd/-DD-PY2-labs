...
class Train:
    ...
    def new_passagers(self, passagers: int) -> int:
        ...
        :raise ValueError: Если количество пассажиров больше 400
        Примеры:
...
class Teapot:
    def __init__(self, capacity_volume: float, occupied_volume: float, power: int):
        ...
        :param occupied_volume: Объем занимаемой жидкости в чайнике (в мл)
        :param power: мощность чайника (в Вт)
        Примеры:
        >>> teapot = Teapot(2, 350, 2000)  # инициализация экземпляра класса
        """
